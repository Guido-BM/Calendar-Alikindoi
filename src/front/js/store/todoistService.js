...
const TOKEN = '8ce5618c71961c8f596f7dc06dd0e6466881b51d'; // Tu token hardcodeado
...
export const addTask = (content) => {
      return api.addTask(content)
            .catch(error => console.error(error));
};

export const updateTask = (id, content) => {
      return api.updateTask(id, content)
            .catch(error => console.error(error));
};
...
export const addLabel = (name) => {
      return api.addLabel(name)
            .catch(error => console.error(error));
};

export const updateLabel = (id, name) => {
      return api.updateLabel(id, name)
            .catch(error => console.error(error));
};
...
export const addReminder = (task_id, due_date) => {
      return api.addReminder(task_id, due_date)
            .catch(error => console.error(error));
};

export const updateReminder = (id, task_id, due_date) => {
      return api.updateReminder(id, task_id, due_date)
            .catch(error => console.error(error));
};
