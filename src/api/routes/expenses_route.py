...
from ..services.expenes_service import ExpenseService
...
def create_expense():
    ...
    if amount and type and user_id:
        new_expense = ExpenseService.create_transaction(amount, description, category, type, user_id)
...
def update_expense(expense_id):
    ...
    if expense:
        ...
        updated_expense = ExpenseService.update_transaction(expense, amount, description, category, type, user_id)
...
def delete_expense_by_id(expense_id):
    expense = ExpenseService.get_transaction_by_id(expense_id)
    if expense:
        ExpenseService.delete_transaction(expense)
